...
void loop(void)
{
  ...
  //  sensor();
  //  delay(2000);
  //  Serial.print("Free RAM p1: "); Serial.println(getFreeRam(), DEC);
  //  uploadData();
  //  Serial.print("Free RAM p2: "); Serial.println(getFreeRam(), DEC);
  //  delay(2000);
  //  if (soilValue < 20) {
  //    for (int j = 0 ; j < 14; j++) {
  //      delay(5000);
...
void commandData() {
  ...
  if (client.connected()) {
    ...
    Serial.print("\n");
    Serial.println(F("-------------------------------------"));
    Serial.print("command Free RAM: "); Serial.println(getFreeRam(), DEC);
    client.close();
    if (cmd.endsWith("@")) {
      Serial.print("RALAY: ");
      Serial.print("OPEN");
